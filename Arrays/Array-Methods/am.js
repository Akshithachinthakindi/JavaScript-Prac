// there are few array methods

// push() method --> to add an item to the end

// pop() method --> to delete an item from end and return
...
// slice() method --> return a piece/sub-array of the array {just as the strings}
